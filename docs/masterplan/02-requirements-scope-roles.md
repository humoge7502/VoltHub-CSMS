...
Grafana dashboard over TimescaleDB (1 hour of work, huge demo payoff); CSV export; GraphQL read endpoint beside REST (only with explicit "why both" answer prepared); multi-currency tariffs; ISO 15118 Plug-and-Charge _simulation_ of the authorize step (concept discussed, not implemented).
