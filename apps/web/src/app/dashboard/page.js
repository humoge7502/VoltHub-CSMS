...
export default function Dashboard() {
  ...
  return (
    <div className="wrap">
      ...
      <label className="micro" htmlFor="station-pick">
        STATION
      </label>
      <select
        id="station-pick"
      ...
      <div className="micro" style={{ margin: '16px 0 8px' }}>
        CONNECTOR GRID · 120px MIN TILES
      </div>
      <div className="tiles">
        {live.map((c) => (
      ...
      <div className="two" style={{ marginTop: 16 }}>
        ...
        <div className="grid">
          <div className="card">
            ...
            <a className="micro" href="/telemetry">
              full telemetry →
            </a>
          </div>
          <div className="card">
