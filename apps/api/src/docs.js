...
Object.assign(spec.paths, {
  ...
  '/reservations/{id}/cancel': { post: P('Optimistic cancel pre-start (operator: station-scoped)') },
  ...
  '/sessions/remote-start': { post: P('Operator RemoteStartTransaction to CP (allow-list idTag, station-scoped)') },
  ...
  '/admin/stations/{id}': { patch: P('Activate/deactivate (ACTIVE|INACTIVE), reassign operator (admin)') },
