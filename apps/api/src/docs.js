...
Object.assign(spec.paths, {
  '/health': { get: P('Liveness + Oracle/Timescale reachability + outbox lag', { security: [] }) },
  ...
  '/stations/{id}/sessions/active': { get: P('Active sessions on this station') },
  ...
  '/sessions/active/{ref}': { get: P('Active session on connector', { security: [] }) },
  '/sessions/{id}/live': { get: P('Live kWh/kW/elapsed/est-cost + 60-pt trace (5s poll)', { security: [] }) },
  ...
  '/telemetry/load-curve': { get: P('Gap-filled load curve (?station&from&to&bucket). Cagg-backed in prod', { security: [] }) },
  '/telemetry/utilization-heatmap': { get: P('7×24 utilization matrix', { security: [] }) },
